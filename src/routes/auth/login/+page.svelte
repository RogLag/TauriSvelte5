    ...
    <div class="flex flex-col gap-1 mt-2 w-full">
      <div class="flex justify-between">
        <Button
          ...
          class="text-xs hover:underline px-0">Mot de passe oublié ?</Button
        >
        <Button
          variant="link"
          href="/auth/register"
          class="text-xs hover:underline px-0">Créer un compte</Button
        >
      </div>
      <Button
        variant="ghost"
        href="/"
        class="text-xs text-gray-500 hover:underline text-center mt-2"
